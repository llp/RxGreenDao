...
public class RxQueryBuilder<T> {
     ...
     */
    public static <T2> RxQueryBuilder<T2> internalCreate(AbstractDao<T2, ?> dao) {
        return new RxQueryBuilder<T2>(dao);
    }

    protected RxQueryBuilder(AbstractDao<T, ?> dao) {
        this(dao, "T");
    }

    protected RxQueryBuilder(AbstractDao<T, ?> dao, String tablePrefix) {
        this.dao = dao;
     ...
     */
    public RxQueryBuilder<T> distinct() {
        distinct = true;
        return this;
    }
     ...
     */
    public RxQueryBuilder<T> where(WhereCondition cond, WhereCondition... condMore) {
     ...
     * given in the generated dao classes.
     */
    public RxQueryBuilder<T> whereOr(WhereCondition cond1, WhereCondition cond2, WhereCondition... condMore) {
     ...
     */
    public RxQueryBuilder<T> orderAsc(Property... properties) {
     ...
     */
    public RxQueryBuilder<T> orderDesc(Property... properties) {
     ...
     */
    public RxQueryBuilder<T> orderCustom(Property property, String customOrderForProperty) {
        checkOrderBuilder();
     ...
     */
    public RxQueryBuilder<T> orderRaw(String rawOrder) {
        checkOrderBuilder();
     ...
     */
    public RxQueryBuilder<T> limit(int limit) {
        this.limit = limit;
        return this;
    }
     ...
     */
    public RxQueryBuilder<T> offset(int offset) {
        this.offset = offset;
        return this;
    }
    ...
    public RxQuery<T> build() {
        ...
        return RxQuery.create(dao, sql, values.toArray(), limitPosition, offsetPosition);
    }
     ...
     */
    public RxCursorQuery buildCursor() {
        StringBuilder builder = createSelectBuilder();
        int limitPosition = checkAddLimit(builder);
        int offsetPosition = checkAddOffset(builder);
        ...
        return RxCursorQuery.create(dao, sql, values.toArray(), limitPosition, offsetPosition);
    }
     ...
     */
    public RxDeleteQuery<T> buildDelete() {
        if (!joins.isEmpty()) {
        ...
        return RxDeleteQuery.create(dao, sql, values.toArray());
    }
     ...
     * QueryBuilder for each execution.
     */
    public RxCountQuery<T> buildCount() {
        String tablename = dao.getTablename();
        ...
        return RxCountQuery.create(dao, sql, values.toArray());
    }
